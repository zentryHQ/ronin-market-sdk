...
import type {
  MarketCommission,
  MarketCommissionInterface,
} from "../MarketCommission";
...
export class MarketCommission__factory {
  static readonly abi = _abi;
  static createInterface(): MarketCommissionInterface {
    return new utils.Interface(_abi) as MarketCommissionInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MarketCommission {
    return new Contract(address, _abi, signerOrProvider) as MarketCommission;
  }
}
