...
import type { MavisExchange, MavisExchangeInterface } from "../MavisExchange";
...
export class MavisExchange__factory {
  static readonly abi = _abi;
  static createInterface(): MavisExchangeInterface {
    return new utils.Interface(_abi) as MavisExchangeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MavisExchange {
    return new Contract(address, _abi, signerOrProvider) as MavisExchange;
  }
}
