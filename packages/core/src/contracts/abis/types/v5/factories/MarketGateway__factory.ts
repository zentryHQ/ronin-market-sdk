...
import type { MarketGateway, MarketGatewayInterface } from "../MarketGateway";
...
export class MarketGateway__factory {
  static readonly abi = _abi;
  static createInterface(): MarketGatewayInterface {
    return new utils.Interface(_abi) as MarketGatewayInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MarketGateway {
    return new Contract(address, _abi, signerOrProvider) as MarketGateway;
  }
}
